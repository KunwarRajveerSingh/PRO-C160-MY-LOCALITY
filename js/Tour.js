AFRAME.registerComponent("tour", {
    ...
    createPlace: function() {
      const details = {
        garden: {
          ...
          src: "./assets/my-locality-assets-main/thumbnails/garden.png",
          title: "Garden",
          id: "garden"
        },
        main_gate: {
          ...
          src: "./assets/my-locality-assets-main/thumbnails/main_gate.png",
          title: "Main Gate",
          id: "main_gate"
        },
        home: {
          ...
          src: "./assets/my-locality-assets-main/thumbnails/home.png",
          title: "Home",
          id: "home"
        }
      };
    ...
    showView: function() {
      ...
      skyEl.setAttribute("material", {
        src: `./assets/my-locality-assets-main/360_images/${selectedPlace}.jpg`,
        color: "#fff"
      });
    },
    update: function() {
